...
#include "../WinMain/IWindProc.h"
//--------------------------------------------------------------------------------
class CPlayerInputComponent; //Sam: forward declaration
class IMenu; //Sam: forward declaration for menu stuff
...
//public: functions
	...
	//Sam: PlayerInputComponent
	const CPlayerInputComponent* GetPlayerInputComponent();
	void RegisterPlayerInput(CPlayerInputComponent*);
	void UnRegisterPlayerInput(CPlayerInputComponent*);

	//Sam: MenuInput
	const IMenu* GetMenuInputComponent();
	void RegisterMenuInput(IMenu*);
	void UnRegisterMenu(IMenu*);

private:
	CPlayerInputComponent* m_pPlayerInput;
	IMenu* m_pMenuInput;
