...
bool CInputManager::Init() {
	...
	if (!ms) {
		Log("Cannot init Input manager without Message system");
		return false;
	}
	if (!em) {
		Log("Cannot init Input manager without Message system");
...
void CInputManager::Update(float fDeltaTime) {
	...
	//if (m_pMenuInput)
	//{
	//	m_pMenuInput->Update(fDeltaTime);
	//}
}
//--------------------------------------------------------------------------------
...
const IMenu* CInputManager::GetMenuInputComponent(void)
{
	return m_pMenuInput;
}

void CInputManager::RegisterMenuInput(IMenu* _arg)
{
	m_pMenuInput = _arg;
}

void CInputManager::UnRegisterMenu(IMenu* _arg)
{
