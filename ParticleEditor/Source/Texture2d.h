...
public:
	...
	Texture2D(ID3D11Device* d3dDevice, ID3D11Texture2D* _texture, const char *_debugName);
	...
	ID3D11RenderTargetView*const* SetRenderTarget(std::size_t arrayIndex = 0) { return &mRenderTargetElements[arrayIndex]; }
...
public:
	...
	ID3D11ShaderResourceView* GetShaderResource() { return mShaderResource; }
	ID3D11ShaderResourceView*const* SetShaderResource() { return &mShaderResource; }
	int Release();
